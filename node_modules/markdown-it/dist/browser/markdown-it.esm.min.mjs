...
function i(e, t) {
	typeof t != "string" && (t = i.defaultChars);
	let n = r(t);
...
var u = /^([a-z0-9.+-]+:)/i, d = /:[0-9]*$/, f = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/, p = [
	...
	"?",
	"#"
], h = 255, g = /^[+a-z0-9A-Z_-]{0,63}$/, _ = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, v = {
	javascript: !0,
	"javascript:": !0
}, y = {
	http: !0,
...
l.prototype.parse = function(e, t) {
	...
	let o = u.exec(a);
	if (o && (o = o[0], n = o.toLowerCase(), this.protocol = o, a = a.substr(o.length)), (t || o || a.match(/^\/\/[^@\/]+@[^@\/]+/)) && (i = a.substr(0, 2) === "//", i && !(o && v[o]) && (a = a.substr(2), this.slashes = !0)), !v[o] && (i || o && !y[o])) {
		let e = -1;
		for (let t = 0; t < m.length; t++) r = a.indexOf(m[t]), r !== -1 && (e === -1 || r < e) && (e = r);
		let t, n;
		...
		if (!o) {
			...
			for (let t = 0, n = e.length; t < n; t++) {
				...
				if (n && !n.match(g)) {
					...
					if (!r.match(g)) {
						let r = e.slice(0, t), i = e.slice(t + 1), o = n.match(_);
		...
		this.hostname.length > h && (this.hostname = ""), o && (this.hostname = this.hostname.substr(1, this.hostname.length - 2));
	}
	let s = a.indexOf("#");
	s !== -1 && (this.hash = a.substr(s), a = a.slice(0, s));
	let c = a.indexOf("?");
	return c !== -1 && (this.search = a.substr(c), a = a.slice(0, c)), a && (this.pathname = a), y[n] && this.hostname && !this.pathname && (this.pathname = ""), this;
...
var ee = /* @__PURE__ */ t({
	...
	S: () => ie,
	Z: () => ae
}), x = /[\0-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, ne = /[\0-\x1F\x7F-\x9F]/, re = /[\xAD\u0600-\u0605\u061C\u06DD\u070F\u0890\u0891\u08E2\u180E\u200B-\u200F\u202A-\u202E\u2060-\u2064\u2066-\u206F\uFEFF\uFFF9-\uFFFB]|\uD804[\uDCBD\uDCCD]|\uD80D[\uDC30-\uDC3F]|\uD82F[\uDCA0-\uDCA3]|\uD834[\uDD73-\uDD7A]|\uDB40[\uDC01\uDC20-\uDC7F]/, S = /[!-#%-\*,-\/:;\?@\[-\]_\{\}\xA1\xA7\xAB\xB6\xB7\xBB\xBF\u037E\u0387\u055A-\u055F\u0589\u058A\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0609\u060A\u060C\u060D\u061B\u061D-\u061F\u066A-\u066D\u06D4\u0700-\u070D\u07F7-\u07F9\u0830-\u083E\u085E\u0964\u0965\u0970\u09FD\u0A76\u0AF0\u0C77\u0C84\u0DF4\u0E4F\u0E5A\u0E5B\u0F04-\u0F12\u0F14\u0F3A-\u0F3D\u0F85\u0FD0-\u0FD4\u0FD9\u0FDA\u104A-\u104F\u10FB\u1360-\u1368\u1400\u166E\u169B\u169C\u16EB-\u16ED\u1735\u1736\u17D4-\u17D6\u17D8-\u17DA\u1800-\u180A\u1944\u1945\u1A1E\u1A1F\u1AA0-\u1AA6\u1AA8-\u1AAD\u1B4E\u1B4F\u1B5A-\u1B60\u1B7D-\u1B7F\u1BFC-\u1BFF\u1C3B-\u1C3F\u1C7E\u1C7F\u1CC0-\u1CC7\u1CD3\u2010-\u2027\u2030-\u2043\u2045-\u2051\u2053-\u205E\u207D\u207E\u208D\u208E\u2308-\u230B\u2329\u232A\u2768-\u2775\u27C5\u27C6\u27E6-\u27EF\u2983-\u2998\u29D8-\u29DB\u29FC\u29FD\u2CF9-\u2CFC\u2CFE\u2CFF\u2D70\u2E00-\u2E2E\u2E30-\u2E4F\u2E52-\u2E5D\u3001-\u3003\u3008-\u3011\u3014-\u301F\u3030\u303D\u30A0\u30FB\uA4FE\uA4FF\uA60D-\uA60F\uA673\uA67E\uA6F2-\uA6F7\uA874-\uA877\uA8CE\uA8CF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA95F\uA9C1-\uA9CD\uA9DE\uA9DF\uAA5C-\uAA5F\uAADE\uAADF\uAAF0\uAAF1\uABEB\uFD3E\uFD3F\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE61\uFE63\uFE68\uFE6A\uFE6B\uFF01-\uFF03\uFF05-\uFF0A\uFF0C-\uFF0F\uFF1A\uFF1B\uFF1F\uFF20\uFF3B-\uFF3D\uFF3F\uFF5B\uFF5D\uFF5F-\uFF65]|\uD800[\uDD00-\uDD02\uDF9F\uDFD0]|\uD801\uDD6F|\uD802[\uDC57\uDD1F\uDD3F\uDE50-\uDE58\uDE7F\uDEF0-\uDEF6\uDF39-\uDF3F\uDF99-\uDF9C]|\uD803[\uDD6E\uDEAD\uDED0\uDF55-\uDF59\uDF86-\uDF89]|\uD804[\uDC47-\uDC4D\uDCBB\uDCBC\uDCBE-\uDCC1\uDD40-\uDD43\uDD74\uDD75\uDDC5-\uDDC8\uDDCD\uDDDB\uDDDD-\uDDDF\uDE38-\uDE3D\uDEA9\uDFD4\uDFD5\uDFD7\uDFD8]|\uD805[\uDC4B-\uDC4F\uDC5A\uDC5B\uDC5D\uDCC6\uDDC1-\uDDD7\uDE41-\uDE43\uDE60-\uDE6C\uDEB9\uDF3C-\uDF3E]|\uD806[\uDC3B\uDD44-\uDD46\uDDE2\uDE3F-\uDE46\uDE9A-\uDE9C\uDE9E-\uDEA2\uDF00-\uDF09\uDFE1]|\uD807[\uDC41-\uDC45\uDC70\uDC71\uDEF7\uDEF8\uDF43-\uDF4F\uDFFF]|\uD809[\uDC70-\uDC74]|\uD80B[\uDFF1\uDFF2]|\uD81A[\uDE6E\uDE6F\uDEF5\uDF37-\uDF3B\uDF44]|\uD81B[\uDD6D-\uDD6F\uDE97-\uDE9A\uDFE2]|\uD82F\uDC9F|\uD836[\uDE87-\uDE8B]|\uD839\uDDFF|\uD83A[\uDD5E\uDD5F]/, ie = /[\$\+<->\^`\|~\xA2-\xA6\xA8\xA9\xAC\xAE-\xB1\xB4\xB8\xD7\xF7\u02C2-\u02C5\u02D2-\u02DF\u02E5-\u02EB\u02ED\u02EF-\u02FF\u0375\u0384\u0385\u03F6\u0482\u058D-\u058F\u0606-\u0608\u060B\u060E\u060F\u06DE\u06E9\u06FD\u06FE\u07F6\u07FE\u07FF\u0888\u09F2\u09F3\u09FA\u09FB\u0AF1\u0B70\u0BF3-\u0BFA\u0C7F\u0D4F\u0D79\u0E3F\u0F01-\u0F03\u0F13\u0F15-\u0F17\u0F1A-\u0F1F\u0F34\u0F36\u0F38\u0FBE-\u0FC5\u0FC7-\u0FCC\u0FCE\u0FCF\u0FD5-\u0FD8\u109E\u109F\u1390-\u1399\u166D\u17DB\u1940\u19DE-\u19FF\u1B61-\u1B6A\u1B74-\u1B7C\u1FBD\u1FBF-\u1FC1\u1FCD-\u1FCF\u1FDD-\u1FDF\u1FED-\u1FEF\u1FFD\u1FFE\u2044\u2052\u207A-\u207C\u208A-\u208C\u20A0-\u20C1\u2100\u2101\u2103-\u2106\u2108\u2109\u2114\u2116-\u2118\u211E-\u2123\u2125\u2127\u2129\u212E\u213A\u213B\u2140-\u2144\u214A-\u214D\u214F\u218A\u218B\u2190-\u2307\u230C-\u2328\u232B-\u2429\u2440-\u244A\u249C-\u24E9\u2500-\u2767\u2794-\u27C4\u27C7-\u27E5\u27F0-\u2982\u2999-\u29D7\u29DC-\u29FB\u29FE-\u2B73\u2B76-\u2BFF\u2CE5-\u2CEA\u2E50\u2E51\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u2FF0-\u2FFF\u3004\u3012\u3013\u3020\u3036\u3037\u303E\u303F\u309B\u309C\u3190\u3191\u3196-\u319F\u31C0-\u31E5\u31EF\u3200-\u321E\u322A-\u3247\u3250\u3260-\u327F\u328A-\u32B0\u32C0-\u33FF\u4DC0-\u4DFF\uA490-\uA4C6\uA700-\uA716\uA720\uA721\uA789\uA78A\uA828-\uA82B\uA836-\uA839\uAA77-\uAA79\uAB5B\uAB6A\uAB6B\uFB29\uFBB2-\uFBD2\uFD40-\uFD4F\uFD90\uFD91\uFDC8-\uFDCF\uFDFC-\uFDFF\uFE62\uFE64-\uFE66\uFE69\uFF04\uFF0B\uFF1C-\uFF1E\uFF3E\uFF40\uFF5C\uFF5E\uFFE0-\uFFE6\uFFE8-\uFFEE\uFFFC\uFFFD]|\uD800[\uDD37-\uDD3F\uDD79-\uDD89\uDD8C-\uDD8E\uDD90-\uDD9C\uDDA0\uDDD0-\uDDFC]|\uD802[\uDC77\uDC78\uDEC8]|\uD803[\uDD8E\uDD8F\uDED1-\uDED8]|\uD805\uDF3F|\uD807[\uDFD5-\uDFF1]|\uD81A[\uDF3C-\uDF3F\uDF45]|\uD82F\uDC9C|\uD833[\uDC00-\uDCEF\uDCFA-\uDCFC\uDD00-\uDEB3\uDEBA-\uDED0\uDEE0-\uDEF0\uDF50-\uDFC3]|\uD834[\uDC00-\uDCF5\uDD00-\uDD26\uDD29-\uDD64\uDD6A-\uDD6C\uDD83\uDD84\uDD8C-\uDDA9\uDDAE-\uDDEA\uDE00-\uDE41\uDE45\uDF00-\uDF56]|\uD835[\uDEC1\uDEDB\uDEFB\uDF15\uDF35\uDF4F\uDF6F\uDF89\uDFA9\uDFC3]|\uD836[\uDC00-\uDDFF\uDE37-\uDE3A\uDE6D-\uDE74\uDE76-\uDE83\uDE85\uDE86]|\uD838[\uDD4F\uDEFF]|\uD83B[\uDCAC\uDCB0\uDD2E\uDEF0\uDEF1]|\uD83C[\uDC00-\uDC2B\uDC30-\uDC93\uDCA0-\uDCAE\uDCB1-\uDCBF\uDCC1-\uDCCF\uDCD1-\uDCF5\uDD0D-\uDDAD\uDDE6-\uDE02\uDE10-\uDE3B\uDE40-\uDE48\uDE50\uDE51\uDE60-\uDE65\uDF00-\uDFFF]|\uD83D[\uDC00-\uDED8\uDEDC-\uDEEC\uDEF0-\uDEFC\uDF00-\uDFD9\uDFE0-\uDFEB\uDFF0]|\uD83E[\uDC00-\uDC0B\uDC10-\uDC47\uDC50-\uDC59\uDC60-\uDC87\uDC90-\uDCAD\uDCB0-\uDCBB\uDCC0\uDCC1\uDCD0-\uDCD8\uDD00-\uDE57\uDE60-\uDE6D\uDE70-\uDE7C\uDE80-\uDE8A\uDE8E-\uDEC6\uDEC8\uDECD-\uDEDC\uDEDF-\uDEEA\uDEEF-\uDEF8\uDF00-\uDF92\uDF94-\uDFEF\uDFFA]/, ae = /[ \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000]/, oe = /* @__PURE__ */ new Map([
	[0, 65533],
	[128, 8364],
	[130, 8218],
	[131, 402],
...
function se(e) {
	var t;
	return e >= 55296 && e <= 57343 || e > 1114111 ? 65533 : (t = oe.get(e)) == null ? e : t;
}
//#endregion
...
function he(e) {
	return e >= E.UPPER_A && e <= E.UPPER_Z || e >= E.LOWER_A && e <= E.LOWER_Z || pe(e);
}
function ge(e) {
	return e === E.EQUALS || he(e);
}
var D;
(function(e) {
...
var _e = class {
	constructor(e, t, n) {
		T(this, "decodeTree", void 0), T(this, "emitCodePoint", void 0), T(this, "errors", void 0), T(this, "state", D.EntityStart), T(this, "consumed", 1), T(this, "result", 0), T(this, "treeIndex", 0), T(this, "excess", 1), T(this, "decodeMode", O.Strict), T(this, "runConsumed", 0), this.decodeTree = e, this.emitCodePoint = t, this.errors = n;
	}
	startEntity(e) {
	...
	write(e, t) {
		switch (this.state) {
			case D.EntityStart: return e.charCodeAt(t) === E.NUM ? (this.state = D.NumericStart, this.consumed += 1, this.stateNumericStart(e, t + 1)) : (this.state = D.NamedEntity, this.stateNamedEntity(e, t));
			...
			case D.NamedEntity: return this.stateNamedEntity(e, t);
		}
	}
	stateNumericStart(e, t) {
		return t >= e.length ? -1 : (e.charCodeAt(t) | fe) === E.LOWER_X ? (this.state = D.NumericHex, this.consumed += 1, this.stateNumericHex(e, t + 1)) : (this.state = D.NumericDecimal, this.stateNumericDecimal(e, t));
	}
	stateNumericHex(e, t) {
		for (; t < e.length;) {
			let n = e.charCodeAt(t);
			if (pe(n) || me(n)) {
				let e = n <= E.NINE ? n - E.ZERO : (n | fe) - E.LOWER_A + 10;
	...
	stateNumericDecimal(e, t) {
		for (; t < e.length;) {
			let n = e.charCodeAt(t);
			if (pe(n)) this.result = this.result * 10 + (n - E.ZERO), this.consumed++, t++;
	...
	emitNumericEntity(e, t) {
		if (this.consumed <= t) {
			var n;
			return (n = this.errors) == null || n.absenceOfDigitsInNumericCharacterReference(this.consumed), 0;
		}
		if (e === E.SEMI) this.consumed += 1;
		else if (this.decodeMode === O.Strict) return 0;
		return this.emitCodePoint(se(this.result), this.consumed), this.errors && (e !== E.SEMI && this.errors.missingSemicolonAfterCharacterReference(), this.errors.validateNumericCharacterReference(this.result)), this.consumed;
	}
	stateNamedEntity(e, t) {
		let { decodeTree: n } = this, r = n[this.treeIndex], i = (r & C.VALUE_LENGTH) >> 14;
		for (; t < e.length;) {
			if (i === 0 && (r & C.FLAG13) !== 0) {
				let a = (r & C.BRANCH_LENGTH) >> 7;
				if (this.runConsumed === 0) {
					let n = r & C.JUMP_TABLE;
				...
				this.runConsumed = 0, this.treeIndex += 1 + (a >> 1), r = n[this.treeIndex], i = (r & C.VALUE_LENGTH) >> 14;
			}
			if (t >= e.length) break;
			let a = e.charCodeAt(t);
			if (a === E.SEMI && i !== 0 && (r & C.FLAG13) !== 0) return this.emitNamedEntityData(this.treeIndex, i, this.consumed + this.excess);
			if (this.treeIndex = ye(n, r, this.treeIndex + Math.max(1, i), a), this.treeIndex < 0) return this.result === 0 || this.decodeMode === O.Attribute && (i === 0 || ge(a)) ? 0 : this.emitNotTerminatedNamedEntity();
			if (r = n[this.treeIndex], i = (r & C.VALUE_LENGTH) >> 14, i !== 0) {
				if (a === E.SEMI) return this.emitNamedEntityData(this.treeIndex, i, this.consumed + this.excess);
				this.decodeMode !== O.Strict && (r & C.FLAG13) === 0 && (this.result = this.treeIndex, this.consumed += this.excess, this.excess = 0);
			}
			t++, this.excess++;
		}
		return -1;
	...
	emitNotTerminatedNamedEntity() {
		var e;
		let { result: t, decodeTree: n } = this, r = (n[t] & C.VALUE_LENGTH) >> 14;
	...
	emitNamedEntityData(e, t, n) {
		...
		return this.emitCodePoint(t === 1 ? r[e] & ~(C.VALUE_LENGTH | C.FLAG13) : r[e + 1], n), t === 3 && this.emitCodePoint(r[e + 2], n), n;
	}
	end() {
		switch (this.state) {
			case D.NamedEntity: return this.result !== 0 && (this.decodeMode !== O.Attribute || this.result === this.treeIndex) ? this.emitNotTerminatedNamedEntity() : 0;
			...
			case D.EntityStart: return 0;
		}
	}
};
function ve(e) {
	let t = "", n = new _e(e, (e) => t += String.fromCodePoint(e));
	return function(e, r) {
		let i = 0, a = 0;
		for (; (a = e.indexOf("&", a)) >= 0;) {
...
function ye(e, t, n, r) {
	let i = (t & C.BRANCH_LENGTH) >> 7, a = t & C.JUMP_TABLE;
...
var be = /* #__PURE__ */ ve(le);
function xe(e) {
	return be(e, O.Strict);
}
//#endregion
...
function j(e) {
	return je.test(e) ? e.replace(Me, Pe) : e;
}
var Fe = /[.?*+^$[\]\\(){}|-]/g;
function Ie(e) {
	return e.replace(Fe, "\\$&");
...
function L(e) {
	let t = 0;
	for (; t < e.length && Re(e.charCodeAt(t)); t++);
	let n = e.length - 1;
	for (; n >= t && Re(e.charCodeAt(n)); n--);
...
function Ve(e, t, n) {
	...
	if (e.charCodeAt(i) === 60) {
		for (i++; i < n;) {
			...
			if (r === 62) return a.pos = i + 1, a.str = A(e.slice(t + 1, i)), a.ok = !0, a;
			if (r === 92 && i + 1 < n) {
				i += 2;
				continue;
			}
	...
	return t === i || o !== 0 ? a : (a.str = A(e.slice(t, i)), a.pos = i, a.ok = !0, a);
}
//#endregion
...
function He(e, t, n, r) {
	...
	for (; a < n;) {
		if (i = e.charCodeAt(a), i === o.marker) return o.pos = a + 1, o.str += A(e.slice(t, a)), o.ok = !0, o;
		if (i === 40 && o.marker === 41) return o;
		i === 92 && a + 1 < n && a++, a++;
	}
	return o.can_continue = !0, o.str += A(e.slice(t, a)), o;
}
//#endregion
//#region src/helpers/index.ts
var Ue = /* @__PURE__ */ t({
	parseLinkDestination: () => Ve,
	parseLinkLabel: () => Be,
	parseLinkTitle: () => He
}), R = class {
	constructor(e, t, n) {
		T(this, "map", null), T(this, "level", 0), T(this, "children", null), T(this, "content", ""), T(this, "markup", ""), T(this, "info", ""), T(this, "block", !1), T(this, "hidden", !1), this.type = e, this.tag = t, this.attrs = null, this.nesting = n, this.meta = null;
	}
	attrIndex(e) {
	...
	constructor() {
		T(this, "__rules__", []), T(this, "__cache__", null);
	}
	__find__(e) {
...
B.code_inline = function(e, t, n, r, i) {
	let a = e[t];
	return `<code${i.renderAttrs(a)}>${j(a.content)}</code>`;
}, B.code_block = function(e, t, n, r, i) {
	let a = e[t];
	return `<pre${i.renderAttrs(a)}><code>${j(e[t].content)}</code></pre>\n`;
}, B.fence = function(e, t, n, r, i) {
	let a = e[t], o = a.info ? A(a.info).trim() : "", s = "", c = "";
	if (o) {
		let e = o.split(/(\s+)/g);
		s = e[0], c = e.slice(2).join("");
	}
	let l;
	if (l = n.highlight && n.highlight(a.content, s, c) || j(a.content), l.indexOf("<pre") === 0) return l + "\n";
	if (o) {
...
}, B.image = function(e, t, n, r, i) {
	let a = e[t];
	return a.attrs[a.attrIndex("alt")][1] = i.renderInlineAsText(a.children, n, r), i.renderToken(e, t, n);
}, B.hardbreak = function(e, t, n) {
	return n.xhtmlOut ? "<br />\n" : "<br>\n";
}, B.softbreak = function(e, t, n) {
	return n.breaks ? n.xhtmlOut ? "<br />\n" : "<br>\n" : "\n";
}, B.text = function(e, t) {
	return j(e[t].content);
}, B.html_block = function(e, t) {
	return e[t].content;
}, B.html_inline = function(e, t) {
	return e[t].content;
};
var We = class {
	constructor() {
		T(this, "rules", Object.assign({}, B));
	}
	renderAttrs(e) {
		let t, n, r;
		if (!e.attrs) return "";
		for (r = "", t = 0, n = e.attrs.length; t < n; t++) r += ` ${j(e.attrs[t][0])}="${j(String(e.attrs[t][1]))}"`;
		return r;
	}
	renderToken(e, t, n) {
		let r = e[t], i = "";
	...
	constructor(e, t, n) {
		T(this, "tokens", []), T(this, "inlineMode", !1), T(this, "Token", R), this.src = e, this.env = n, this.md = t;
	}
}, Ke = /\r\n?/g, qe = /\0/g;
function Je(e) {
	let t;
...
function et(e) {
	...
	if (e.md.options.linkify) for (let n = 0, r = t.length; n < r; n++) {
		...
		for (let t = r.length - 1; t >= 0; t--) {
			...
			if (n.type === "html_inline" && (Qe(n.content) && a > 0 && a--, $e(n.content) && a++), !(a > 0) && n.type === "text" && e.md.linkify.test(n.content)) {
...
var tt = /\+-|\.\.|\?\?\?\?|!!!!|,,|--/, nt = /\((c|tm|r)\)/i, rt = /\((c|tm|r)\)/gi, it = {
	c: "©",
	r: "®",
	tm: "™"
};
...
function ot(e) {
	...
	for (let n = e.length - 1; n >= 0; n--) {
		let r = e[n];
		r.type === "text" && !t && (r.content = r.content.replace(rt, at)), r.type === "link_open" && r.info === "auto" && t--, r.type === "link_close" && r.info === "auto" && t++;
	}
}
function st(e) {
	let t = 0;
	for (let n = e.length - 1; n >= 0; n--) {
		let r = e[n];
		r.type === "text" && !t && tt.test(r.content) && (r.content = r.content.replace(/\+-/g, "±").replace(/\.{2,}/g, "…").replace(/([?!])…/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---(?=[^-]|$)/gm, "$1—").replace(/(^|\s)--(?=\s|$)/gm, "$1–").replace(/(^|[^-\s])--(?=[^-\s]|$)/gm, "$1–")), r.type === "link_open" && r.info === "auto" && t--, r.type === "link_close" && r.info === "auto" && t++;
	}
}
function ct(e) {
	let t;
	if (e.md.options.typographer) for (t = e.tokens.length - 1; t >= 0; t--) e.tokens[t].type === "inline" && (nt.test(e.tokens[t].content) && ot(e.tokens[t].children), tt.test(e.tokens[t].content) && st(e.tokens[t].children));
}
//#endregion
...
function pt(e, t) {
	...
	for (let a = 0; a < e.length; a++) {
		...
		OUTER: for (; l < u;) {
			...
			let g = F(m) || P(m), _ = F(h) || P(h), v = N(m), y = N(h);
			...
			if (f) for (n = r.length - 1; n >= 0; n--) {
				...
				if (e.single === p && r[n].level === s) {
					e = r[n];
					let s, c;
					p ? (s = t.md.options.quotes[2], c = t.md.options.quotes[3]) : (s = t.md.options.quotes[0], c = t.md.options.quotes[1]), V(i, a, o.index, c), V(i, e.token, e.pos, s), r.length = n;
					continue OUTER;
				}
			}
			d ? r.push({
				...
				single: p,
				level: s
			}) : f && p && V(i, a, o.index, dt);
		}
	}
	Object.keys(i).forEach(function(t) {
		let n = Number(t);
		e[n].content = ft(e[n].content, i[t]);
	});
}
function mt(e) {
	if (e.md.options.typographer) for (let t = e.tokens.length - 1; t >= 0; t--) e.tokens[t].type !== "inline" || !lt.test(e.tokens[t].content) || pt(e.tokens[t].children, e);
}
//#endregion
...
function gt(e) {
	...
	for (let e = 0; e < i; e++) {
		...
		for (t = 0; t < a; t++) i[t].type === "text_special" && (i[t].type = "text"), i[t].children && ht(i[t].children);
...
var H = [
	...
	constructor() {
		T(this, "ruler", new z()), T(this, "State", Ge);
		for (let e = 0; e < H.length; e++) this.ruler.push(H[e][0], H[e][1]);
	}
	process(e) {
	...
	constructor(e, t, n, r) {
		T(this, "bMarks", []), T(this, "eMarks", []), T(this, "tShift", []), T(this, "sCount", []), T(this, "bsCount", []), T(this, "blkIndent", 0), T(this, "line", 0), T(this, "lineMax", 0), T(this, "tight", !1), T(this, "listIndent", -1), T(this, "parentType", "root"), T(this, "level", 0), T(this, "Token", R), this.src = e, this.md = t, this.env = n, this.tokens = r;
		let i = this.src;
	...
	skipSpaces(e) {
		for (let t = this.src.length; e < t && M(this.src.charCodeAt(e)); e++);
		return e;
	}
	skipSpacesBack(e, t) {
		if (e <= t) return e;
		for (; e > t;) if (!M(this.src.charCodeAt(--e))) return e + 1;
		return e;
	}
	skipChars(e, t) {
	...
	getLines(e, t, n, r) {
		...
		for (let a = 0, o = e; o < t; o++, a++) {
			...
			for (l = o + 1 < t || r ? this.eMarks[o] + 1 : this.eMarks[o]; c < l && e < n;) {
				...
				if (M(t)) t === 9 ? e += 4 - (e + this.bsCount[o]) % 4 : e++;
...
function xt(e, t, n, r) {
	...
	if (s !== 124 && s !== 45 && s !== 58 && !M(s) || o === 45 && M(s)) return !1;
	for (; a < e.eMarks[i];) {
		let t = e.src.charCodeAt(a);
		if (t !== 124 && t !== 45 && t !== 58 && !M(t)) return !1;
		a++;
	}
	let c = U(e, t + 1), l = c.split("|"), u = [];
	...
	if (c = U(e, t).trim(), c.indexOf("|") === -1 || e.sCount[t] - e.blkIndent >= 4) return !1;
	l = bt(c), l.length && l[0] === "" && l.shift(), l.length && l[l.length - 1] === "" && l.pop();
	let d = l.length;
	...
	for (i = t + 2; i < n && !(e.sCount[i] < e.blkIndent); i++) {
		...
		if (r || (c = U(e, i).trim(), !c) || e.sCount[i] - e.blkIndent >= 4 || (l = bt(c), l.length && l[0] === "" && l.shift(), l.length && l[l.length - 1] === "" && l.pop(), y += d - l.length, y > yt)) break;
		if (i === t + 2) {
	...
	for (m = t; m < n; m++) {
		...
		if (e.src.charCodeAt(i++) === 62 && !t) {
			...
			for (s.push(e.bMarks[m]), e.bMarks[m] = i; i < a;) {
				...
				if (M(t)) t === 9 ? o += 4 - (o + e.bsCount[m] + +!!r) % 4 : o++;
				else break;
				i++;
			}
...
function Et(e, t) {
	...
	return i !== 42 && i !== 45 && i !== 43 || r < n && !M(e.src.charCodeAt(r)) ? -1 : r;
}
function Dt(e, t) {
	...
	return i < r && (a = e.src.charCodeAt(i), !M(a)) ? -1 : i;
}
function Ot(e, t) {
	let n = e.level + 2;
...
function kt(e, t, n, r) {
	...
	for (e.parentType = "list"; c < n;) {
		...
		let y = e.tight, b = e.tShift[c], ee = e.sCount[c], te = e.listIndent;
		...
		if (x) break;
		if (d) {
			if (p = Dt(e, c), p < 0) break;
			o = e.bMarks[c] + e.tShift[c];
		} else if (p = Et(e, c), p < 0) break;
		if (m !== e.src.charCodeAt(p - 1)) break;
	}
	return s = d ? e.push("ordered_list_close", "ol", -1) : e.push("bullet_list_close", "ul", -1), s.markup = String.fromCharCode(m), g[1] = c, e.line = c, e.parentType = y, l && Ot(e, h), !0;
}
//#endregion
...
function At(e, t, n, r) {
	...
	let g;
	for (i < a && m !== i && h.ok ? (g = h.str, i = h.pos) : (g = "", i = f, o = p); i < a && M(c.charCodeAt(i));) i++;
	if (i < a && c.charCodeAt(i) !== 10 && g) for (g = "", i = f, o = p; i < a && M(c.charCodeAt(i));) i++;
...
var jt = /* @__PURE__ */ "address.article.aside.base.basefont.blockquote.body.caption.center.col.colgroup.dd.details.dialog.dir.div.dl.dt.fieldset.figcaption.figure.footer.form.frame.frameset.h1.h2.h3.h4.h5.h6.head.header.hr.html.iframe.legend.li.link.main.menu.menuitem.nav.noframes.ol.optgroup.option.p.param.search.section.summary.table.tbody.td.tfoot.th.thead.title.tr.track.ul".split("."), Mt = "<[A-Za-z][A-Za-z0-9\\-]*(?:\\s+[a-zA-Z_:][a-zA-Z0-9:._-]*(?:\\s*=\\s*(?:[^\"'=<>`\\x00-\\x20]+|'[^']*'|\"[^\"]*\"))?)*\\s*\\/?>", Nt = "<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>", Pt = RegExp(`^(?:${Mt}|${Nt}|<!---?>|<!--(?:[^-]|-[^-]|--[^>])*-->|<[?][\\s\\S]*?[?]>|<![A-Za-z][^>]*>|<!\\[CDATA\\[[\\s\\S]*?\\]\\]>)`), Ft = RegExp(`^(?:${Mt}|${Nt})`), W = [
	[
...
function It(e, t, n, r) {
	...
	if (r) return W[s][2];
	let c = t + 1, l = W[s][1].test("");
	if (!W[s][1].test(o)) {
		for (; c < n && !(e.sCount[c] < e.blkIndent && (l || !e.isEmpty(c))); c++) if (i = e.bMarks[c] + e.tShift[c], a = e.eMarks[c], o = e.src.slice(i, a), W[s][1].test(o)) {
			o.length !== 0 && c++;
			break;
		}
	}
...
function Rt(e, t, n) {
	...
	let c = L(e.getLines(t, s, e.blkIndent, !1));
	e.line = s + 1;
...
function zt(e, t, n) {
	...
	let o = L(e.getLines(t, a, e.blkIndent, !1));
	e.line = a;
...
var G = [
	...
	constructor() {
		T(this, "ruler", new z()), T(this, "State", vt);
		for (let e = 0; e < G.length; e++) this.ruler.push(G[e][0], G[e][1], { alt: (G[e][2] || []).slice() });
	}
	tokenize(e, t, n) {
	...
	constructor(e, t, n, r) {
		T(this, "pos", 0), T(this, "level", 0), T(this, "pending", ""), T(this, "pendingLevel", 0), T(this, "cache", {}), T(this, "backticks", {}), T(this, "backticksScanned", !1), T(this, "linkLevel", 0), T(this, "delimiters", []), T(this, "_prev_delimiters", []), T(this, "Token", R), this.src = e, this.env = n, this.md = t, this.tokens = r, this.tokens_meta = Array(r.length), this.posMax = this.src.length;
	}
	pushPending() {
		let e = new R("text", "", 0);
	...
	scanDelims(e, t) {
		...
		let c = F(i) || P(i), l = F(s) || P(s), u = N(i), d = N(s), f = !d && (!l || u || c), p = !u && (!c || d || l);
		return {
			can_open: f && (t || !p || c),
			can_close: p && (t || !f || l),
			length: o
...
function Ut(e, t) {
	let n = e.pos;
	for (; n < e.posMax && !Ht(e.src.charCodeAt(n));) n++;
...
function Kt(e, t) {
	...
	for (; a > i && Gt(e.src.charCodeAt(a - 1));) a--;
	if (a === n || !Wt(e.src.charCodeAt(a))) return !1;
...
function qt(e, t) {
	...
	for (n++; n < i && M(e.src.charCodeAt(n));) n++;
	return e.pos = n, !0;
}
//#endregion
//#region src/rules_inline/escape.ts
var K = [];
for (let e = 0; e < 256; e++) K.push(0);
...
function Jt(e, t) {
	...
	if (i === 10) {
		for (t || e.push("hardbreak", "br", 0), n++; n < r && (i = e.src.charCodeAt(n), M(i));) n++;
		return e.pos = n, !0;
	}
	if (i === 32) {
		if (!t) {
	...
	if (!t) {
		let t = e.push("text_special", "", 0);
		t.content = i < 256 && K[i] !== 0 ? a : o, t.markup = o, t.info = "escape";
	}
	return e.pos = n + 1, !0;
}
//#endregion
...
function Xt(e, t) {
	var n;
	let r = e.pos;
	if (e.src.charCodeAt(r) !== 96) return !1;
	let i = e.posMax, a = r + 1;
	for (; a < i && e.src.charCodeAt(a) === 96;) a++;
	let o = e.src.slice(r, a), s = o.length;
	if (e.backticksScanned || (e.backticks = Yt(e.src), e.backticksScanned = !0), ((n = e.backticks[s]) == null ? -1 : n) >= a) {
		let n = a, r;
		for (; (r = e.src.indexOf("`", n)) !== -1 && r < i;) {
			for (n = r + 1; e.src.charCodeAt(n) === 96;) n++;
			if (n > i) break;
			if (n - r === s) {
				if (!t) {
...
function $t(e) {
	...
	for (let i = 0; i < n; i++) {
		var r;
		let n = (r = t[i]) == null ? void 0 : r.delimiters;
		n && Qt(e, n);
	}
}
var en = {
...
function on(e, t) {
	...
	if (m < d && e.src.charCodeAt(m) === 40) {
		for (l = !1, m++; m < d && (n = e.src.charCodeAt(m), !(!M(n) && n !== 10)); m++);
		if (m >= d) return !1;
		if (c = m, i = e.md.helpers.parseLinkDestination(e.src, m, e.posMax), i.ok) {
			for (o = e.md.normalizeLink(i.str), e.md.validateLink(o) ? m = i.pos : o = "", c = m; m < d && (n = e.src.charCodeAt(m), !(!M(n) && n !== 10)); m++);
			if (i = e.md.helpers.parseLinkTitle(e.src, m, e.posMax), m < d && c !== m && i.ok) for (s = i.str, m = i.pos; m < d && (n = e.src.charCodeAt(m), !(!M(n) && n !== 10)); m++);
		}
		(m >= d || e.src.charCodeAt(m) !== 41) && (l = !0), m++;
	}
	if (l) {
		if (e.env.references === void 0) return !1;
		if (m < d && e.src.charCodeAt(m) === 91 ? (c = m + 1, m = e.md.helpers.parseLinkLabel(e, m), m >= 0 ? r = e.src.slice(c, m++) : m = p + 1) : m = p + 1, r || (r = e.src.slice(f, p)), r = I(r), a = e.env.references[r], !a) return e.pos = u, !1;
		o = a.href, s = a.title;
	}
	if (!t) {
		e.pos = f, e.posMax = p;
...
function sn(e, t) {
	...
	if (a = m + 1, a < f && e.src.charCodeAt(a) === 40) {
		for (a++; a < f && (n = e.src.charCodeAt(a), !(!M(n) && n !== 10)); a++);
		if (a >= f) return !1;
		for (l = a, s = e.md.helpers.parseLinkDestination(e.src, a, e.posMax), s.ok && (u = e.md.normalizeLink(s.str), e.md.validateLink(u) ? a = s.pos : u = ""), l = a; a < f && (n = e.src.charCodeAt(a), !(!M(n) && n !== 10)); a++);
		if (s = e.md.helpers.parseLinkTitle(e.src, a, e.posMax), a < f && l !== a && s.ok) for (c = s.str, a = s.pos; a < f && (n = e.src.charCodeAt(a), !(!M(n) && n !== 10)); a++);
		else c = "";
		if (a >= f || e.src.charCodeAt(a) !== 41) return e.pos = d, !1;
		a++;
	} else {
		if (e.env.references === void 0) return !1;
		if (a < f && e.src.charCodeAt(a) === 91 ? (l = a + 1, a = e.md.helpers.parseLinkLabel(e, a), a >= 0 ? i = e.src.slice(l, a++) : a = m + 1) : a = m + 1, i || (i = e.src.slice(p, m)), i = I(i), o = e.env.references[i], !o) return e.pos = d, !1;
		u = o.href, c = o.title;
	}
	if (!t) {
		r = e.src.slice(p, m);
...
var cn = /^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/, ln = /^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/;
function un(e, t) {
	let n = e.pos;
...
function mn(e, t) {
	...
	if (i !== 33 && i !== 63 && i !== 47 && !pn(i)) return !1;
	let a = e.src.slice(r).match(Pt);
	if (!a) return !1;
	if (!t) {
		let t = e.push("html_inline", "", 0);
		t.content = a[0], dn(t.content) && e.linkLevel++, fn(t.content) && e.linkLevel--;
	}
	return e.pos += a[0].length, !0;
}
//#endregion
//#region src/rules_inline/entity.ts
var hn = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i, gn = /^&([a-z][a-z0-9]{1,31});/i;
function _n(e, t) {
	let n = e.pos, r = e.posMax;
	if (e.src.charCodeAt(n) !== 38 || n + 1 >= r) return !1;
	if (e.src.charCodeAt(n + 1) === 35) {
		let r = e.src.slice(n).match(hn);
		if (r) {
			if (!t) {
				let t = r[1][0].toLowerCase() === "x" ? parseInt(r[1].slice(1), 16) : parseInt(r[1], 10), n = e.push("text_special", "", 0);
				n.content = Te(t) ? k(t) : k(65533), n.markup = r[0], n.info = "entity";
			}
			return e.pos += r[0].length, !0;
		}
	} else {
		let r = e.src.slice(n).match(gn);
		if (r) {
			let n = xe(r[0]);
			if (n !== r[0]) {
				if (!t) {
...
function yn(e) {
	...
	for (let e = 0; e < n; e++) {
		var r;
		let n = (r = t[e]) == null ? void 0 : r.delimiters;
		n && vn(n);
	}
}
//#endregion
...
var q = [
	...
	["emphasis", an.postProcess],
	["fragments_join", bn]
], Sn = class {
	constructor() {
		T(this, "ruler", new z()), T(this, "ruler2", new z()), T(this, "State", Vt);
		for (let e = 0; e < q.length; e++) this.ruler.push(q[e][0], q[e][1]);
		for (let e = 0; e < xn.length; e++) this.ruler2.push(xn[e][0], xn[e][1]);
	}
	skipToken(e) {
	...
	constructor(e = {}) {
		T(this, "src_Any", x.source), T(this, "src_Cc", ne.source), T(this, "src_Z", ae.source), T(this, "src_P", S.source), T(this, "src_ZPCc", [
			this.src_Z,
			this.src_P,
			this.src_Cc
		].join("|")), T(this, "src_ZCc", [this.src_Z, this.src_Cc].join("|")), T(this, "cache", {}), T(this, "opts", {
			maxLength: 1e4,
			urlAuth: !1,
			schema_names: []
		}), this.opts = {
	...
	get_text_separators() {
		var e, t;
		return (t = (e = this.cache).text_separators) == null ? e.text_separators = /[><\uff5c]/ : t;
	}
	get_pseudo_letter() {
		var e, t;
		return (t = (e = this.cache).src_pseudo_letter) == null ? e.src_pseudo_letter = RegExp(`(?:(?!${this.get_text_separators().source}|${this.src_ZPCc})${this.src_Any})`) : t;
	}
	get_ipv4_addr() {
		var e, t;
		return (t = (e = this.cache).src_ip4) == null ? e.src_ip4 = /* @__PURE__ */ RegExp("(?:(?:25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])[.]){3}(?:25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])") : t;
	}
	get_ipv6_addr() {
		var e, t;
		let n = "[0-9A-Fa-f]{1,4}", r = `(?:(?:${n}:${n})|${this.get_ipv4_addr().source})`;
		return (t = (e = this.cache).src_ip6_addr) == null ? e.src_ip6_addr = RegExp(`(?:(?:${n}:){6}${r}|::(?:${n}:){5}${r}|(?:${n})?::(?:${n}:){4}${r}|(?:(?:${n}:){0,1}${n})?::(?:${n}:){3}${r}|(?:(?:${n}:){0,2}${n})?::(?:${n}:){2}${r}|(?:(?:${n}:){0,3}${n})?::${n}:${r}|(?:(?:${n}:){0,4}${n})?::${r}|(?:(?:${n}:){0,5}${n})?::${n}|(?:(?:${n}:){0,6}${n})?::)`) : t;
	}
	get_ipv6_url_host() {
		var e, t;
		return (t = (e = this.cache).src_ip6_host) == null ? e.src_ip6_host = RegExp(`\\[${this.get_ipv6_addr().source}\\]`) : t;
	}
	get_ipv6_mail_host() {
		var e, t;
		return (t = (e = this.cache).src_ipv6_mail_host) == null ? e.src_ipv6_mail_host = RegExp(`\\[IPv6:${this.get_ipv6_addr().source}\\]`) : t;
	}
	get_auth() {
		var e, t;
		return (t = (e = this.cache).src_auth) == null ? e.src_auth = RegExp(`(?:(?:(?!${this.src_ZCc}|[@/\\[\\]()]).){1,50}@)?`) : t;
	}
	get_port() {
		var e, t;
		return (t = (e = this.cache).src_port) == null ? e.src_port = /* @__PURE__ */ RegExp("(?::(?:6(?:[0-4]\\d{3}|5(?:[0-4]\\d{2}|5(?:[0-2]\\d|3[0-5])))|[1-5]?\\d{1,4}))?") : t;
	}
	get_host_terminator() {
		var e, t;
		return (t = (e = this.cache).src_host_terminator) == null ? e.src_host_terminator = RegExp(`(?=$|${this.get_text_separators().source}|${this.src_ZPCc})(?!${this.opts["---"] ? "-(?!--)|" : "-|"}_|:\\d|\\.-|\\.(?!$|${this.src_ZPCc}))`) : t;
	}
	get_path_terminator() {
		var e, t;
		return (t = (e = this.cache).src_path_terminator) == null ? e.src_path_terminator = RegExp(`${this.src_ZPCc}|${this.get_text_separators().source}`) : t;
	}
	get_path() {
		var e, t;
		return (t = (e = this.cache).src_path) == null ? e.src_path = RegExp(`(?:[/?#](?:${this.nestedPairRE("[", "]")}|${this.nestedPairRE("(", ")")}|${this.nestedPairRE("{", "}")}|\\"(?:(?!${this.src_ZCc}|["]).){1,100}\\"|\\'(?:(?!${this.src_ZCc}|[']).){1,100}\\'|\\'(?=${this.get_pseudo_letter().source}|[-])|\\.{2,20}[:]?[a-zA-Z0-9%/&]|\\.(?!${this.src_ZCc}|[.]|$)|` + (this.opts["---"] ? "\\-(?!--(?:[^-]|$))(?:-{0,19})|" : "\\-{1,20}|") + `,(?!${this.src_ZCc}|$)|;(?!${this.src_ZCc}|$)|\\!{1,20}(?!${this.src_ZCc}|[!]|$)|\\?(?!${this.src_ZCc}|[?]|$)|` + this.get_path_extra().source + `[\\\\/:%@#&=_~*]|(?!${this.get_path_terminator().source}).){1,${this.opts.maxLength}}|\\/)?`) : t;
	}
	get_mail_name() {
		var e, t;
		return (t = (e = this.cache).src_mail_name) == null ? e.src_mail_name = /* @__PURE__ */ RegExp("[-!#$%&'*+/=?^_`{|}~a-zA-Z0-9](?:[-!#$%&'*+/=?^_`{|}~a-zA-Z0-9]|[.](?=[-!#$%&'*+/=?^_`{|}~a-zA-Z0-9])){0,63}") : t;
	}
	get_xn() {
		var e, t;
		return (t = (e = this.cache).src_xn) == null ? e.src_xn = /* @__PURE__ */ RegExp("xn--[a-z0-9\\-]{1,59}") : t;
	}
	get_tld() {
	...
	get_domain_root() {
		var e, t;
		return (t = (e = this.cache).src_domain_root) == null ? e.src_domain_root = RegExp("(?:" + this.get_xn().source + `|${this.get_pseudo_letter().source}{1,63})`) : t;
	}
	get_domain() {
		var e, t;
		return (t = (e = this.cache).src_domain) == null ? e.src_domain = RegExp("(?:" + this.get_xn().source + `|(?:${this.get_pseudo_letter().source})|(?:${this.get_pseudo_letter().source}(?:-|${this.get_pseudo_letter().source}){0,61}${this.get_pseudo_letter().source}))`) : t;
	}
	get_url_host_port() {
		var e, t;
		return (t = (e = this.cache).url_host_port) == null ? e.url_host_port = RegExp("(?:" + this.get_ipv6_url_host().source + `|(?:(?:(?:${this.get_domain().source})\\.){0,10}${this.get_domain().source}))` + this.get_port().source + this.get_host_terminator().source) : t;
	}
	get_fuzzy_url_host_port() {
		var e, t;
		return (t = (e = this.cache).fuzzy_url_host_port) == null ? e.fuzzy_url_host_port = RegExp("(?:" + (this.opts.fuzzyIP ? this.get_ipv4_addr().source + "|" : "") + `(?:(?:(?:${this.get_domain().source})\\.){1,10}(?:${this.get_tld().source})))` + this.get_host_terminator().source) : t;
	}
	get_mail_host() {
		var e, t;
		return (t = (e = this.cache).src_mail_host) == null ? e.src_mail_host = RegExp("(?:" + this.get_ipv6_mail_host().source + `|(?:(?:(?:${this.get_domain().source})\\.){0,4}${this.get_domain().source}))` + this.get_host_terminator().source) : t;
	}
	get_fuzzy_mail_host() {
		var e, t;
		return (t = (e = this.cache).src_fuzzy_mail_host) == null ? e.src_fuzzy_mail_host = RegExp("(?:" + this.get_ipv6_mail_host().source + `|(?:(?:(?:${this.get_domain().source})[.]){1,4}${this.get_domain_root().source}))` + this.get_host_terminator().source) : t;
	}
	get_path_extra() {
		var e, t;
		return (t = (e = this.cache).src_path_extra) == null ? e.src_path_extra = /* @__PURE__ */ RegExp("") : t;
	}
	get_fuzzy_mail_host_search() {
		var e, t;
		return (t = (e = this.cache).mail_fuzzy_host_search) == null ? e.mail_fuzzy_host_search = RegExp(`@${this.get_fuzzy_mail_host().source}`, "ig") : t;
	}
	get_fuzzy_link_search() {
		var e, t;
		return (t = (e = this.cache).link_fuzzy_search) == null ? e.link_fuzzy_search = RegExp(`(^|(?![.:/\\-_@])(?:[$+<=>^\`|\uff5c]|${this.src_ZPCc}))(?:(?![$+<=>^\`|\uff5c])${this.get_fuzzy_url_host_port().source}${this.get_path().source})`, "ig") : t;
	}
	get_http_validator() {
		var e, t;
		return (t = (e = this.cache).http_validator) == null ? e.http_validator = RegExp("\\/\\/" + (this.opts.urlAuth ? this.get_auth().source : "") + this.get_url_host_port().source + this.get_path().source, "iy") : t;
	}
	get_relative_proto_validator() {
		var e, t;
		return (t = (e = this.cache).relative_proto_validator) == null ? e.relative_proto_validator = RegExp((this.opts.urlAuth ? this.get_auth().source : "") + `(?:localhost|${this.get_ipv6_url_host().source}|(?:(?:${this.get_domain().source})[.]){1,10}${this.get_domain_root().source})` + this.get_port().source + this.get_host_terminator().source + this.get_path().source, "iy") : t;
	}
	get_mail_name_validator() {
		var e, t;
		return (t = (e = this.cache).mail_name_validator) == null ? e.mail_name_validator = RegExp(`(?:^|${this.get_text_separators().source}|"|\\(|${this.src_ZCc})(${this.get_mail_name().source})$`) : t;
	}
	get_mailto_validator() {
		var e, t;
		return (t = (e = this.cache).mailto_validator) == null ? e.mailto_validator = RegExp(`${this.get_mail_name().source}@${this.get_mail_host().source}`, "iy") : t;
	}
	get_schema_names() {
		var e, t;
		return (t = (e = this.cache).schema_names) == null ? e.schema_names = new RegExp((this.opts.schema_names || []).map((e) => this.escapeRE(e)).join("|")) : t;
	}
	get_schema_search() {
		var e, t;
		return (t = (e = this.cache).schema_search) == null ? e.schema_search = RegExp(`(^|(?!_)(?:[><\uff5c]|${this.src_ZPCc}))(${this.get_schema_names().source})`, "ig") : t;
	}
	get_schema_at_start() {
		var e, t;
		return (t = (e = this.cache).schema_at_start) == null ? e.schema_at_start = RegExp(`^${this.get_schema_search().source}`, "i") : t;
	}
}, wn = {
	validate: (e, t, n) => {
...
var kn = {
	...
	constructor(e, t, n, r) {
		T(this, "schema", void 0), T(this, "index", void 0), T(this, "lastIndex", void 0), T(this, "raw", void 0), T(this, "text", void 0), T(this, "url", void 0);
		let i = e.slice(n, r);
		this.schema = t.toLowerCase(), this.index = n, this.lastIndex = r, this.raw = i, this.text = i, this.url = i;
	}
}, jn = class {
	constructor(e = {}) {
		T(this, "__opts__", void 0), T(this, "__schemas__", void 0), T(this, "re", void 0);
		let { rebuilder: t, ...n } = e;
		this.__opts__ = {
			...kn,
			...n
		}, this.__schemas__ = { ...Tn }, this.re = t || new Cn(), this.re.set({
			...this.__opts__,
	...
	match(e) {
		...
		for (n.lastIndex = 0, this.__opts__.fuzzyLink && this.__schemas__["http:"] && (r = this.re.get_fuzzy_link_search(), r.lastIndex = 0), this.__opts__.fuzzyEmail && this.__schemas__["mailto:"] && (i = this.re.get_fuzzy_mail_host_search(), i.lastIndex = 0, a = this.re.get_mail_name_validator());;) {
			...
			let _ = new An(e, g.schema, g.index, g.lastIndex);
	...
	matchAtStart(e) {
		...
		if (!n) return null;
		let r = new An(e, t[2], t.index + t[1].length, t.index + t[0].length + n);
...
}, J = 2147483647, Y = 36, Mn = 1, X = 26, Nn = 38, Pn = 700, Fn = 72, In = 128, Ln = "-", Rn = /^xn--/, zn = /[^\0-\x7F]/, Bn = /[\x2E\u3002\uFF0E\uFF61]/g, Vn = {
	overflow: "Overflow: input needs wider integers to process",
	"not-basic": "Illegal input >= 0x80 (not a basic code point)",
	"invalid-input": "Invalid input"
}, Hn = 35, Z = Math.floor, Un = String.fromCharCode;
function Q(e) {
	throw RangeError(Vn[e]);
}
function Wn(e, t) {
	let n = [], r = e.length;
	for (; r--;) n[r] = t(e[r]);
...
function Gn(e, t) {
	let n = e.split("@"), r = "";
	n.length > 1 && (r = n[0] + "@", e = n[1]), e = e.replace(Bn, ".");
	let i = Wn(e.split("."), t).join(".");
	return r + i;
}
function Kn(e) {
...
var qn = (e) => String.fromCodePoint(...e), Jn = function(e) {
	return e >= 48 && e < 58 ? 26 + (e - 48) : e >= 65 && e < 91 ? e - 65 : e >= 97 && e < 123 ? e - 97 : Y;
}, Yn = function(e, t) {
	return e + 22 + 75 * (e < 26) - ((t != 0) << 5);
}, Xn = function(e, t, n) {
	let r = 0;
	for (e = n ? Z(e / Pn) : e >> 1, e += Z(e / t); e > 455; r += Y) e = Z(e / Hn);
	return Z(r + 36 * e / (e + Nn));
}, Zn = function(e) {
	let t = [], n = e.length, r = 0, i = In, a = Fn, o = e.lastIndexOf(Ln);
	o < 0 && (o = 0);
	...
	for (let s = o > 0 ? o + 1 : 0; s < n;) {
		...
		for (let t = 1, i = Y;; i += Y) {
			s >= n && Q("invalid-input");
			let o = Jn(e.charCodeAt(s++));
			o >= Y && Q("invalid-input"), o > Z((J - r) / t) && Q("overflow"), r += o * t;
			let c = i <= a ? Mn : i >= a + X ? X : i - a;
			if (o < c) break;
			let l = Y - c;
			t > Z(J / l) && Q("overflow"), t *= l;
		}
		let c = t.length + 1;
		a = Xn(r - o, c, o == 0), Z(r / c) > J - i && Q("overflow"), i += Z(r / c), r %= c, t.splice(r++, 0, i);
	}
	return String.fromCodePoint(...t);
}, Qn = function(e) {
	let t = [];
	e = Kn(e);
	let n = e.length, r = In, i = 0, a = Fn;
	for (let n of e) n < 128 && t.push(Un(n));
	let o = t.length, s = o;
	for (o && t.push(Ln); s < n;) {
		let n = J;
		for (let t of e) t >= r && t < n && (n = t);
		let c = s + 1;
		n - r > Z((J - i) / c) && Q("overflow"), i += (n - r) * c, r = n;
		for (let n of e) if (n < r && ++i > J && Q("overflow"), n === r) {
			let e = i;
			for (let n = Y;; n += Y) {
				let r = n <= a ? Mn : n >= a + X ? X : n - a;
				if (e < r) break;
				let i = e - r, o = Y - r;
				t.push(Un(Yn(r + i % o, 0))), e = Z(i / o);
			}
			t.push(Un(Yn(e, 0))), a = Xn(i, c, s === o), i = 0, ++s;
		}
		++i, ++r;
	}
	return t.join("");
	...
	toASCII: function(e) {
		return Gn(e, function(e) {
			return zn.test(e) ? "xn--" + Qn(e) : e;
		});
	},
	toUnicode: function(e) {
		return Gn(e, function(e) {
			return Rn.test(e) ? Zn(e.slice(4).toLowerCase()) : e;
		});
	}
}, er = {
	default: {
...
}, tr = /^(vbscript|javascript|file|data):/, nr = /^data:image\/(gif|png|jpeg|webp);/, rr = [
	"http:",
	"https:",
	"mailto:"
], $ = class {
	validateLink(e) {
		...
		return !tr.test(t) || nr.test(t);
	}
	normalizeLink(e) {
		let t = b(e, !0);
		if (t.hostname && (!t.protocol || rr.indexOf(t.protocol) >= 0)) try {
			t.hostname = $n.toASCII(t.hostname);
		} catch (e) {}
		return t.auth && (t.auth = s(t.auth)), t.hostname && (t.hostname = s(t.hostname)), t.pathname && (t.pathname = s(t.pathname)), t.search && (t.search = s(t.search)), t.hash && (t.hash = s(t.hash)), c(t);
	}
	normalizeLinkText(e) {
		let t = b(e, !0);
		if (t.hostname && (!t.protocol || rr.indexOf(t.protocol) >= 0)) try {
			t.hostname = $n.toUnicode(t.hostname);
		} catch (e) {}
		return i(c(t), i.defaultChars + "%");
	}
	constructor(...e) {
		T(this, "inline", new Sn()), T(this, "block", new Bt()), T(this, "core", new _t()), T(this, "renderer", new We()), T(this, "linkify", new jn()), T(this, "utils", Se), T(this, "helpers", Object.assign({}, Ue));
		let [t, n] = e;
	...
	configure(e) {
		...
		if (typeof e == "string") {
			let n = e;
			if (t = er[n], !t) throw Error(`Wrong 'markdown-it' preset "${n}", check name`);
		} else t = e;
		...
		if (n) {
			...
			[
				...
				var t;
				let r = (t = n[e]) == null ? void 0 : t.rules;
				r && this[e].ruler.enableOnly(r);
			});
			let e = (r = n.inline) == null ? void 0 : r.rules2;
...
T($, "Token", R), T($, "Ruler", z), T($, "Renderer", We), T($, "ParserCore", _t), T($, "StateCore", Ge), T($, "ParserBlock", Bt), T($, "StateBlock", vt), T($, "ParserInline", Sn), T($, "StateInline", Vt);
//#endregion
//#region src/index.ts
var ir = Ce($);
//#endregion
...
//# sourceMappingURL=markdown-it.esm.min.mjs.map